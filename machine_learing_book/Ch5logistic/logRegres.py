...
def load_data_set():
    data_mat = []
    label_mat = []
    fr = open('/Users/wangxiao15/Desktop/machinelearninginaction/Ch05/testSet.txt')
...
def stoc_grad_ascent0(dataMatrix, classLabels):
...
def stoc_grad_ascent1(dataMatrix, classLabels, numberIter=150):
    m, n = shape(dataMatrix)
    weights = ones(n)  # initialize to all ones
...
def colic_test():
    fr_train = open('/Users/wangxiao15/Desktop/machinelearninginaction/Ch05/horseColicTraining.txt')
    fr_test = open('/Users/wangxiao15/Desktop/machinelearninginaction/Ch05/horseColicTest.txt')
    training_set = []
    training_labels = []
